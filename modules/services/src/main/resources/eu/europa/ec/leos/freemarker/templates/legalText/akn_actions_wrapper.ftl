...
<#macro clause>
    <#local editable = (.node["@leos:editable"][0]!'false') == 'true'>
    <#local optionList = .node["@leos:optionlist"][0]??>
...
<#if (editable || deletable)>
<div class="leos-wrap" data-wrapped-editable="${editable?c}" data-wrapped-id="${wrappedId}" data-wrapped-type="${wrappedType}">
    <div class="leos-wrap-content">
        <#fallback>
    </div>
    <div class="leos-wrap-widgets">
