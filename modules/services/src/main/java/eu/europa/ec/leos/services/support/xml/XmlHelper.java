...
public class XmlHelper {
    ...
    public static String getAnnexTemplate() {
        ...
        StringBuilder template = new StringBuilder();
        template.append("<blockContainer GUID=\"").append(id).append("\" leos:editable=\"true\"  leos:deletable=\"true\">");
        template.append("<p GUID=\"").append(id).append("_par1\">");
        template.append("Text...");
        template.append("</p>");
        template.append("</blockContainer>");
        return template.toString();
    }
    ...
    private static final ArrayList<String> exclusionList= new ArrayList<String>(Arrays.asList(AUTHORIALNOTE, NUM, POPUP, CLAUSE));
