...
//import eu.europa.ec.leos.services.toc.DocType;
...
//TODO : Need to recreate the serialized objects for new attributes like TocItem
...
//		entities.add(new Entity(1l, "EXT.A1", "Ext"));
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_DELETE, "bill_delete__citation_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_DELETE, "bill_delete__recital_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_DELETE, "bill_delete__part_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_DELETE, "bill_delete__title_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_DELETE, "bill_delete__chapter_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_DELETE, "bill_delete__section_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_DELETE, "bill_delete__article_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_MOVE, "bill_move__citation_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_MOVE, "bill_move__recital_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_MOVE, "bill_move__part_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_MOVE, "bill_move__title_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_MOVE, "bill_move__chapter_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_MOVE, "bill_move__section_output.xml");
...
//		// Given
//		final byte[] xmlInput = TestUtils.getFileContent("/integration/", "bill_ec_chapter_section_title_3Articles.xml");
//		final byte[] xmlExpected = TestUtils.getFileContent(PREFIX_MOVE, "bill_move__article_output.xml");
...
//		byte[] xmlResult = vtdXmlContentProcessor.createDocumentContentWithNewTocList(structureService.getTocItems(DocType.BILL), toc, xmlInput, getTestUser());
