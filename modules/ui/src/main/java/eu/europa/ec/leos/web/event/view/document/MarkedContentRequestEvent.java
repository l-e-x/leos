...
public class MarkedContentRequestEvent {
    ...
    public MarkedContentRequestEvent(LeosDocumentProperties oldVersion, LeosDocumentProperties newVersion, int displayMode) {
