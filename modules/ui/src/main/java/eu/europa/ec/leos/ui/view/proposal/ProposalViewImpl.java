...
@SpringView(name = ProposalView.VIEW_ID)
class ProposalViewImpl extends AbstractLeosView<ProposalScreenImpl> implements ProposalView {

    private static final long serialVersionUID = 1L;

    @Autowired
    ProposalViewImpl(ProposalScreenImpl screen, ProposalPresenter presenter) {
