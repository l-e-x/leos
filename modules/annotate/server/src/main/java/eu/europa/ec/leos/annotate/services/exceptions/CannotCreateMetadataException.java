...
public class CannotCreateMetadataException extends Exception {
    ...
    public CannotCreateMetadataException(Throwable e) {
        super("The metadata cannot be registered in the database", e);
    }

    public CannotCreateMetadataException(String msg) {
        super(msg);
    }
}
