...
public class AnnotationComparator implements Comparator<Annotation>, Serializable {
    ...
    public static final List<String> SORTABLE_COLUMN_NAMES = Collections.unmodifiableList(Arrays.asList("created", "updated", "shared"));
    ...
    // Constructor
    // -------------------------------------
    public AnnotationComparator(Sort sort) {
