...
<span id="leos-coverpage" class="leos-coverpage">
    <span id="leos-cover-logo" class="leos-cover-logo">
        <img src="${webContextPath}/static/decide/img/logo-ce-horizontal-en.png" width="326" height="86" alt="European Commission" title="European Commission"/>
    </span>
    ...
    <span id="leos-cover-preface" class="leos-preface-on-cover">
        <#if (xml.akomaNtoso.bill.preface?size gt 0)>
            <#recurse xml.akomaNtoso.bill.preface using aknFtl>
        </#if>
    </span>
