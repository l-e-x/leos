 ...
 */
define(function sideCommentsModule(require, exports, module) {
  ...
  function SideComments(el, currentUser, existingComments) {
    ...
    this.$body.on('click' + this.eventNamespace, _.bind(this.bodyClick, this));
  ...
  SideComments.prototype.initialize = function (existingComments) {
    _.each(this.$el.find('.commentable-section'), _.bind(function (section) {
      var $section = $(section);
  ...
  SideComments.prototype.destroy = function () {
    ...
    // unbind events
    this.$body.off(this.eventNamespace);
  };
