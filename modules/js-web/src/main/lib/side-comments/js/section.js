 ...
 */
define(function sectionModule(require, exports, module) {

	var _ = require('lodash');
	var Template = require('text!../templates/section.html');
	var CommentTemplate = require('text!../templates/comment.html');
	var mobileCheck = require('./helpers/mobile-check');
	var $ = require('jquery');
	...
	function Section(eventPipe, $el, currentUser, comments) {
		...
		this.eventNamespace = ".sideComments";
		this.clickEventName = (mobileCheck() ? 'touchstart' : 'click') + this.eventNamespace;
	...
	/**
	 * Destroy this Section object. Generally meaning unbind events.
	 */
