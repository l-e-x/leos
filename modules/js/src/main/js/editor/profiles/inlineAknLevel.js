...
define(function aknLevelProfileModule(require) {
    ...
    plugins.push(require("plugins/aknLevelOrderedList/aknLevelOrderedListPlugin"));
    plugins.push(require("plugins/aknLevelList/aknLevelListPlugin"));
    plugins.push(require("plugins/aknLevelIndentList/aknLevelIndentListPlugin"));
