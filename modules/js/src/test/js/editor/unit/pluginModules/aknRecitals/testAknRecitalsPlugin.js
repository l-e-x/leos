...
define(function testAknRecitalsPlugin(require) {
    ...
    describe("Unit tests for plugins/aknRecitalsPlugin", function() {
        var transformationConfigForRecitals = '{"akn":"recitals","html":"div[data-akn-name=recitals]","attr":[{"akn":"GUID","html":"id"},{"akn":"leos:editable","html":"data-akn-attr-editable"},{"html":"data-akn-name=recitals"}]}';
