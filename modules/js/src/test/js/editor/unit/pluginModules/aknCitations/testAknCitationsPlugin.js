...
define(function testAknCitationsPlugin(require) {
    ...
    describe("Unit tests for plugins/aknCitationsPlugin", function() {
        var transformationConfigForCitations = '{"akn":"citations","html":"div[data-akn-name=citations]","attr":[{"akn":"GUID","html":"id"},{"akn":"leos:editable","html":"data-akn-attr-editable"},{"html":"data-akn-name=citations"}]}';
