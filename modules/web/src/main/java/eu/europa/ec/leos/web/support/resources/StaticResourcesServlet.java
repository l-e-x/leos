...
public class StaticResourcesServlet extends HttpServlet {
    ...
    private void doRequest(HttpServletRequest request, HttpServletResponse response, boolean head) throws IOException {
        ...
        response.setContentType(getServletContext().getMimeType(resource.getName()));
        ...
        try ( ReadableByteChannel inputChannel = Channels.newChannel(new FileInputStream(resource));
            ...
            if (resource.length() == -1 && !response.isCommitted()) {
    ...
    protected File getStaticResource(HttpServletRequest request) throws Exception {
