...
public class TableOfContentComponent extends CustomComponent {
    ...
    private Component buildTocToolbar() {
        ...
        // Table of Content toolbar icon updater
        Object toctIconPositionUpdater = new Object() {
            @Subscribe
            public void updateTocSliderIcon(TocPositionEvent event) {
                tocToolsLayout.removeComponent(tocSlideButton);
        ...
        eventBus.register(toctIconPositionUpdater);
