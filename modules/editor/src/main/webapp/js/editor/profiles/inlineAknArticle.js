...
//    plugins.push(require("plugins/leosInlineCancel/leosInlineCancelPlugin"));
    ...
    var profileConfig = {
        ...
        plugins: "toolbar,wysiwygarea,elementspath,floatingspace," + "clipboard,undo,enterkey,entities," + "button,dialog,dialogui,sourcearea,"
                + "widget,lineutils,basicstyles," + "list,indentlist,indent,"
                + "link,fakeobjects,find,specialchar,table,tableresize,tabletools,contextmenu,menubutton,mathjax,pastetext,colorbutton",
        ...
        lite: {
            includes: ["js/rangy/rangy-core.js", "js/ice.js", "js/dom.js", "js/selection.js", "js/bookmark.js", "lite-interface.js"],
            tooltips: {
                show: false
            },
            isTracking: false
