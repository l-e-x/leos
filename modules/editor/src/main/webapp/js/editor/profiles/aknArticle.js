...
define(function aknArticleProfileModule(require) {
    ...
    var profileConfig = {
        ...
        plugins: "toolbar,wysiwygarea,elementspath," + "clipboard,undo,enterkey,entities," + "button,dialog,dialogui,sourcearea,"
        ...
        mathJaxLib: 'http://cdn.mathjax.org/mathjax/2.3-latest/MathJax.js?config=default',
