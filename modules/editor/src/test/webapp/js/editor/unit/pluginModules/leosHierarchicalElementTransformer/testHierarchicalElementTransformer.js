...
define(function testHierarchicalElementTransformer(require) {
    ...
    describe(
            ...
            function() {
                ...
                describe(
                        "Check if custom transformation done correctly.",
                        function() {
                            describe(
                                    "From HTML to AKN side ",
                                    function() {
                                        it(
                                                "Element only with inline content.",
                                                function() {
                                                    var elementToBeTransformed = fromFragmentToElement(ckEditorFragmentFactory
                                                            .getCkFragmentForHtml("<ul><li>fdsafsa</li></ul>"));
                                                    ...
                                                    var fragmentMock = {
                                                        mapToProducts : function() {
                                                            expect(JSON.stringify(arguments[1]))
                                                                    .toEqual(
                                                                            '[{"toPath":"list/indent"},{"toPath":"list/indent/num"},{"toPath":"list/indent/num/text","fromAttribute":"data-akn-num"}]');
                                                        },
                                                        mapToChildProducts : function() {
                                                            if (mapToChildProductsCounter === 0) {
                                                                expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"list/indent","toChild":"content"}');
                                                            } else if (mapToChildProductsCounter === 1) {
                                                                expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"list/indent/content","toChild":"mp"}');
                                        ...
                                        it(
                                                "Element with inline content, nested inline content not wrapped in p and block content .",
                                                function() {
                                                    var elementToBeTransformed = fromFragmentToElement(ckEditorFragmentFactory
                                                    ...
                                                    var fragmentMock = {
                                                        ...
                                                        mapToChildProducts : function() {
                                                            if (mapToChildProductsCounter === 0) {
                                                                ...
                                                                expect(JSON.stringify(arguments[1])).toEqual(
                                                                        '{"toPath":"list/indent/alinea","toChild":"content"}');
                                                            } else if (mapToChildProductsCounter === 2) {
                                                                expect(JSON.stringify(arguments[1])).toEqual(
                                                                        '{"toPath":"list/indent/alinea/content","toChild":"mp"}');
                                        ...
                                        it(
                                                "Element with inline content, nested inline content wrapped with p and block content .",
                                                function() {
                                                    var elementToBeTransformed = fromFragmentToElement(ckEditorFragmentFactory
                                    ...
                                    function() {
                                        ...
                                        it("Element only with inline content.", function() {
                                            ...
                                            var fragmentMock = {
                                                ...
                                                mapToChildProducts : function() {
                                                    if (mapToChildProductsCounter === 0) {
                                                        expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"ul","toChild":"li"}');
                                                    } else if (mapToChildProductsCounter === 1) {
                                                        expect(JSON.stringify(arguments[1])).toEqual(
                                        ...
                                        it(
                                                "Element only with inline content, block content and nested inline content.",
                                                function() {
                                                    var elementToBeTransformed = fromFragmentToElement(ckEditorFragmentFactory
                                                    ...
                                                    var fragmentMock = {
                                                        ...
                                                        mapToChildProducts : function() {
                                                            if (mapToChildProductsCounter === 0) {
                                                                ...
                                                                expect(JSON.stringify(arguments[1])).toEqual('{"toPath":"ul/li","toChild":"p"}');
                                                            } else if (mapToChildProductsCounter === 2) {
