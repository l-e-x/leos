...
define(function testAknCitationPlugin(require) {
    ...
    describe("Unit tests for plugins/aknCitationPlugin", function() {
        var transformationConfigForCitation = '{"akn":"citation","html":"p","attr":[{"akn":"id","html":"id"},{"akn":"leos:editable","html":"contenteditable"},{"html":"data-akn-name=citation"}],"sub":{"akn":"mp","html":"p","attr":[{"akn":"id","html":"data-akn-mp-id"}],"sub":{"akn":"text","html":"p/text"}}}';
