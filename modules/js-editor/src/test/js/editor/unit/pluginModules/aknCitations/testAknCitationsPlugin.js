...
define(function testAknCitationsPlugin(require) {
    ...
    describe("Unit tests for plugins/aknCitationsPlugin", function() {
        var transformationConfigForCitations = '{"akn":"citations","html":"div[data-akn-name=citations]","attr":[{"akn":"id","html":"id"},{"html":"class=citations"},{"akn":"leos:editable","html":"contenteditable"},{"html":"data-akn-name=citations"}]}';
