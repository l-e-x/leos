...
// NOTE set variable with full path on local file system
def repoLocalPath = '<TODO>/LEOS-Pilot/tools/cmis/chemistry-opencmis-server-inmemory'

def loader = new LeosLoader(repoLocalPath, session)
...
class LeosLoader {
    ...
    static final PROPS_FILE_PATH = '/src/main/webapp/WEB-INF/classes/repository.properties'
    static final RESOURCES_PATH = '/src/main/resources'
    ...
    final String LOCAL_BASE_PATH
    final Map<String, String> PARAMETERS
    final Session SESSION

    LeosLoader(String repoLocalPath, Session session) {
        this.LOCAL_BASE_PATH = repoLocalPath

        def localPropsPath = LOCAL_BASE_PATH + PROPS_FILE_PATH
        println "Loading properties file: $localPropsPath"

        def properties = new java.util.Properties()

        def propsFile = new File(localPropsPath)
    ...
    private InputStream loadResource(String path) {
        def localResourcePath = LOCAL_BASE_PATH + RESOURCES_PATH + path
